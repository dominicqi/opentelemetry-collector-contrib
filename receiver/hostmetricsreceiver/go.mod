...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/experimentalmetricmetadata v0.106.0
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatatest v0.106.0
	github.com/prometheus-community/windows_exporter v0.26.0
